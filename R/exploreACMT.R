...
#'   minimum and maximum in dB, default c(-60, -26). Must be a whole number.
#' @param short
...
exploreACMT <- function(maindir, rdat="ACMT", AC=TRUE, MT=TRUE, ageSp=NULL,
  ...
  para("Created using the R package EchoNet2Fish (https://github.com/phillipskr/EchoNet2Fish), written by Jean V. Adams, Dave Warner, and Kristy Phillips.")
